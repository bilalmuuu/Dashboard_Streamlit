...
try:
    ...
    st.error(f"File mapping tidak ditemukan di: {mapping_path}. Harap pastikan lokasi file dan penamaan file benar.")
    st.stop()
...
if selected_tab == tabs[0]:
    ...
    if selected_branches:
        ...
        st.info("💡 Ketik dan pilih maksimal 3 Kantor Cabang pada *Search Bar* di atas untuk memulai analisis.")