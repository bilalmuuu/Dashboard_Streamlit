...
def render_gender_age_chart(df):
    ...
    age_order = [
        "17 -19 tahun", "20 - 25 tahun", "26 - 30 tahun",
        "31 - 35 tahun", "36 - 40 tahun", "41 - 45 tahun",
        "46 - 50 tahun", "50 tahun dan ke atas"
    ]
...
def create_geomap_distribution(df, city_col="Kab Kota"):
    ...
    try:
        ...
        st.error(f"File GeoJSON tidak ditemukan! Pastikan file berada di: {geojson_path}")
        return
    ...
    colormap.caption = 'Jumlah Responden'
    ...
    if geojson_aktif['features']:
        folium.GeoJson(
            ...
            tooltip=folium.GeoJsonTooltip(
                ...
                aliases=['Kota/Kabupaten:', 'Jumlah Nasabah:'],
                localize=True,
